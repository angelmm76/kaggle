...
for pr in targetprods:
    print(pr)
    f, l = 600000, 929615
    testprobs.append(tclfdict[pr].predict_proba(Xtest[f:l])[:, 1])

testprobs = np.array(testprobs).T
print(testprobs.shape) # m k (929615 12)
testp0 = testprobs
testp1 = testprobs
testp2 = testprobs
testprobs = np.vstack((testp0, testp1, testp2))
...
# Submit 
print('Submitting...')
subname = 'Data/SantanderXGB7jun15_all_12m_prov.csv'
sub = tids.to_frame()
