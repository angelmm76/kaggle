...
# jun15, 12 prods, nocv, lag4: 0.05093 (LB 0.0300084***)  mdep 5
# jun15, 12 prods, nocv, lag5: 0.05362

# jun15, 12 prods, lag3, prov: 0.05045
# jun15, 12 prods, nocv, lag4, prov: 0.05097 (LB 0.0299637)

# jun15, 12new prods, lag4, nocv: 0.05144 (LB 0.0296536)

# jun15, 14 prods, nocv, lag4: 0.05166 (LB 0.0298413)

# jun15, 10 prods, lag2: 0.05009 (LB 0.0295116)   

# jun15, 22 prods, lag1: 0.05045    lag2: 0.05097 (LB 0.0295251)   
# lag3: 0.05119   lag4: 0.05138     lag5: 0.05499
...
# Prod08 jun2015 onlyaddedclients, 22 prods  (prod05 all clients, XGB:0.04621)
# XGB: 0.04688 (LB 0.0270346),   RF: 0.04503   BernNB: 0.04300
# XGB+eval_set: 0.04595 (LB 0.0270533)
# jun2015 onlyaddedclients, 12 prods 
# XGB: 0.04688 (LB 0.0270346),   RF: 0.04503   BernNB: 0.04300
...
# Submit 
print('Submitting...')
subname = 'Data/SantanderXGB10_lag4_12pr_nocv_md6.csv'
sub = tids.to_frame()
