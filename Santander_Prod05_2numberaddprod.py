...
# Total added products (931453 clients)
#ind_recibo_ult1      10220.0       #ind_ctju_fin_ult1       77.0
#ind_nom_pens_ult1     5541.0       #ind_fond_fin_ult1       61.0
#ind_nomina_ult1       5516.0       #ind_dela_fin_ult1       46.0
#ind_cco_fin_ult1      5511.0       #ind_plan_fin_ult1       22.0
#ind_tjcr_fin_ult1     4252.0       #ind_pres_fin_ult1        7.0
#ind_ecue_fin_ult1     2723.0       #ind_viv_fin_ult1         7.0
#ind_cno_fin_ult1      2369.0       #ind_cder_fin_ult1        5.0
#ind_ctma_fin_ult1      713.0       #ind_hip_fin_ult1         3.0
#ind_reca_fin_ult1      283.0       #ind_ahor_fin_ult1        1.0
#ind_ctop_fin_ult1      226.0       #ind_deco_fin_ult1        0.0
#ind_valo_fin_ult1      183.0       #ind_deme_fin_ult1        0.0
#ind_ctpp_fin_ult1      131.0       #ind_aval_fin_ult1        0.0
...
def getTrainData(mdata, prmdata):
...
X = getTrainData(mdata[clientfeatures], prevmdata).drop(['ncodpers'], axis=1)
...
print('\nLearning number of added products...')
clfdict = {}
scores = []
freq = ytrain.sum(axis=0)
for i in range(1, len(targetprods)+1):
    probs = []
    targprods_i = targetprods[:i]
    print(i, targprods_i)
    for pr in targprods_i:
        #print(pr)         
    ...
    print('MAP@7 score: %0.7f' % mapscore)
    scores.append(mapscore)
    
plt.plot(range(1, len(targetprods)+1), scores)
plt.xlabel('n target prods')
plt.ylabel('map7')
plt.show()

maxmap = max(scores)
ntar = scores.index(maxmap)
print('Maximum map7: %f, %d products' % (maxmap, ntar+1))

# targetprods22, jun15
# XGB: 0.044580, 10      RF: 0.043367, 9     BernNB: 0.04179, 10 
# targetprods12, may16
# XGB: 0.044904, 12    RF: 0.043680, 16    BernNB: 0.041987, 11 
...
# Pickle dump clf
filename = 'clfsBernNBSantander5.p'
fileObject = open(fiename,'wb') 
...
Xtest = getTrainData(tdata[clientfeatures], prtmdata)
tids = Xtest['ncodpers']
...
filename = 'clfsBernNBSantander5.p'
tclfdict = pickle.load(open(filename,'r'))
testprobs = []
...
print('Create test added product...')
...
# LB: BernNB  0.0112358
print('Submitting...')
subname = 'Data/SantanderBernNB5.csv'
sub = tids.to_frame()
